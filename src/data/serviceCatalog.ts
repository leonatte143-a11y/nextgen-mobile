...
export const MAIN_CATEGORIES: MainCategory[] = [
  {
    ...
    subServices: [
      ...
      { id: 'hs_wood', title: 'Wood Works', subtitle: 'Carpentry', icon: 'hammer-outline', searchQuery: 'wood works carpenter' },
      { id: 'hs_tiles', title: 'Tiles', subtitle: 'Flooring & marble', icon: 'grid-outline', searchQuery: 'tiles marble' },
  ...
  },
  {
    ...
    subServices: [
      ...
      { id: 'hr_system', title: 'System Repair', subtitle: 'PC & Laptop', icon: 'laptop-outline', searchQuery: 'computer system repair' },
    ],
  },
  {
    ...
    subServices: [
      ...
      { id: 'pe_auto', title: 'Auto Drivers', subtitle: 'City rides', icon: 'navigate-outline', searchQuery: 'auto driver' },
